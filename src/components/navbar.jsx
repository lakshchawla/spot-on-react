    ...
    <>
      ...
      <div class="offcanvas offcanvas-end text-white" tabindex="-1" id="offcanvasRight"
        ...
        <div class="offcanvas-body offcanvas_menu">
          <ul class="links_canvas">
            ...
            <li>
              <h3 class="mt-3"><a href="/sales">Sales</a></h3>
            </li>
            <li>
              <h3 class="mt-3"><a href="/">Services</a></h3>
            </li>
            <li>
              <h3 class="mt-3"><a href="/about">About</a></h3>
            </li>
            <li>
              <h3 class="mt-3"><a href="/">Contact Us</a></h3>
            </li>
            <li>
      ...
      <nav className="navbar bg-black" data-aos="fade-down" data-aos-duration="400">
        <div className="container-fluid col-md-8">
          ...
          <div>
            <a href="tel:+91 7027693815" class='me-md-4 me-3 wa_link text-decoration-none'><svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" class="bi bi-telephone-fill" viewBox="0 0 16 16">
              <path fill-rule="evenodd" d="M1.885.511a1.745 1.745 0 0 1 2.61.163L6.29 2.98c.329.423.445.974.315 1.494l-.547 2.19a.678.678 0 0 0 .178.643l2.457 2.457a.678.678 0 0 0 .644.178l2.189-.547a1.745 1.745 0 0 1 1.494.315l2.306 1.794c.829.645.905 1.87.163 2.611l-1.034 1.034c-.74.74-1.846 1.065-2.877.702a18.634 18.634 0 0 1-7.01-4.42 18.634 18.634 0 0 1-4.42-7.009c-.362-1.03-.037-2.137.703-2.877L1.885.511z" />
            </svg></a>
            <a href="https://api.whatsapp.com/send/?phone=917027693815&text&type=phone_number&app_absent=0" class='me-md-4 me-3 wa_link text-decoration-none'><svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" class="bi bi-whatsapp me-0 me-md-1" viewBox="0 0 16 16">
            ...
            <button type="button" class="btn btn-light me-3 btn-sm" data-bs-toggle="modal" data-bs-target="#exampleModal">
              GET IN TOUCH
            </button>
            <button
